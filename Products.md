...
The KibrisOrder API lets you do the following with the Product resource.
...
### Create a new product with a product image which will be downloaded by KibrisOrder  
POST /api/products  
```json
{
  "product": {
